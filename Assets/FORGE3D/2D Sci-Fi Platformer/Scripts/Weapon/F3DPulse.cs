...
//[ExecuteInEditMode]
public class F3DPulse : F3DGenericProjectile
{
...
//            _linePoints[1].z = 0;
            ...
            if (Hit && !_alreadyHit)
            {
                DealDamage(transform.root.gameObject, DamageAmount, WeaponType, lineHit.transform, Hit, HitLifeTime, lineHit.point, lineHit.normal);
                _alreadyHit = true;
